...
namespace Ltracker.data.Repositories
{
    ...
    public class CourseRepository : BaseRepository<Course>
    {
        ...
        public void InserCourseWithTopics(Course course, int[] selectedTopics)
        {
        ...
        public void UpdateCourseWithTopics(Course course)
        {
            int[] selectedTopics = course.Topics.Select(x => x.Id.Value).ToArray();
            course.Topics = new List<Topic>();
